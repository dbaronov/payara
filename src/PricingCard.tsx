                        ...
                        darkMode
                          ?
                            <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fillRule="evenodd" clipRule="evenodd" d="M16.665 32C25.5016 32 32.665 24.8366 32.665 16C32.665 7.16344 25.5016 0 16.665 0C7.82848 0 0.665039 7.16344 0.665039 16C0.665039 24.8366 7.82848 32 16.665 32ZM22.458 13.1495C22.7247 12.8957 22.7351 12.4737 22.4813 12.207C22.2274 11.9403 21.8054 11.9299 21.5387 12.1838L14.3385 19.0379L11.8333 16.1763C11.5908 15.8992 11.1696 15.8713 10.8926 16.1138C10.6156 16.3563 10.5876 16.7775 10.8301 17.0545L13.7931 20.4391C13.9127 20.5758 14.0829 20.6577 14.2644 20.666C14.4458 20.6742 14.6228 20.6081 14.7543 20.4829L22.458 13.1495Z" fill="#DDD6FE"/>
                            </svg>
